...
public class TencentUtil {
    ...
    public static void qqLogin(Activity activity, Tencent tencent, IUserInfoListener listener) {
        tencent.login(activity, "all", new BaseUiListener(activity, tencent, listener));
    }
}
