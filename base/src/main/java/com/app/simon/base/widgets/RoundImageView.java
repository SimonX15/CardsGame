package com.app.simon.base.widgets;
...
import com.app.simon.base.R;


/**
 * 圆形/圆角图片
 * <p/>
 * Created by Simon on 2016/7/2.
 */
...
//        Log.e("TAG", "onDraw");
        ...
        if (type == TYPE_ROUND) {
            ...
            canvas.drawCircle(mRadiusX, mRadiusY, mRadius, mBitmapPaint);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (type == TYPE_CIRCLE) {
            ...
            if (mWidth == getMeasuredWidth()) {
                mRadiusX = mRadius;
                mRadiusY = getMeasuredHeight() / 2;
            } else {
                mRadiusX = getMeasuredHeight() / 2;
                mRadiusY = mRadius;
            }
            //重新设置大小
